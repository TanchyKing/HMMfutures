...
# 获取数据
data = pd.read_excel('T DATA HMM.xlsx')
...
# 获取增加的变量，并从第五天开始算起
Due1year = dataRATE['中债国债到期收益率:1年'][dayn+5:]
Due10years = dataRATE['中债国债到期收益率:10年'][dayn+5:]
Due5years = dataRATE['中债国债到期收益率:5年'][dayn+5:]
FR007 = dataRATE['回购定盘利率:7天(FR007)'][dayn+5:]
Due3months = dataRATE['中债国债到期收益率:3个月'][dayn+5:]
Ini10years = dataRATE['中债国开债到期收益率:10年'][dayn+5:]
LPR = dataRATE['贷款基础利率(LPR):1年'][dayn+5:]
diff_10years1year = dataRATE['中债国债到期收益率:10年:-中债国债到期收益率:1年'][dayn+5:]
diff_10years5years = dataRATE['中债国债到期收益率:10年:-中债国债到期收益率:5年'][dayn+5:]
diff_RATE = dataRATE['贷款基础利率(LPR):1年:-中债国开债到期收益率:10年'][dayn+5:]
HRB = dataRATE['价格:螺纹钢:HRB400 20mm:全国'][dayn+5:]
HN_IPE = dataRATE['南华工业品指数'][dayn+5:]
coaltot = dataRATE['日均耗煤量:6大发电集团:合计'][dayn+5:]
...
# 获取交易期间的总天数DAYS
startday = '%s' % Date[dayn+5+days_diff]
startday = startday[:10]
endday = '%s' % Date[days+dayn+4+days_diff]
endday = endday[:10]
